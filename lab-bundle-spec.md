...
Any custom outputs being generated with a `startup_script` can be reference as [PROJECT].<FILL-IN-OUTPUT-NAME>. The output will be displayed as a copyable text if provided within the student_visible_outputs.
